...
const translations = {
  ru: {
    ...
    featureCenterSub:'Пилимо, рядом со Старым городом', featureKitchen:'Мини‑кухня', featureKitchenSub:'кофе, чай, посуда, приборы',
    featureLift:'Лифт', featureLiftSub:'в здании', featureBathroom:'Своя ванная', featureBathroomSub:'душ, полотенца и бельё', featureWifi:'Wi‑Fi', featureWifiSub:'Быстрый и бесплатный интернет', featureCheckin:'Самостоятельное заселение', featureCheckinSub:'Мини‑сейф с ключом', featureComfort:'Комфортное проживание', featureComfortSub:'Всё для вашего удобства', locationHint:'Откройте карту, чтобы увидеть точное расположение квартиры.',
    ...
    aBedText:'Двуспальное место для комфортного отдыха.', aKitchen:'Мини‑кухня', aKitchenText:'Кофе, чай, посуда и приборы для простого завтрака.',
    ...
    galleryEyebrow:'ПОСМОТРИТЕ БЛИЖЕ', galleryTitle:'Квартира в деталях.', allPhotos:'Все 12 фото', gApartment:'Интерьер',
    ...
    bookAirbnb:'Забронировать на Airbnb', checkinText:'Самостоятельное заселение · ключ в мини‑сейфе', backTop:'Наверх', galleryDialogLabel:'ГАЛЕРЕЯ', close:'Закрыть',
  ...
  en: {
    ...
    featureCenterSub:'Pylimo, near the Old Town', featureKitchen:'Kitchenette', featureKitchenSub:'coffee, tea, tableware and cutlery',
    featureLift:'Elevator', featureLiftSub:'in the building', featureBathroom:'Private bathroom', featureBathroomSub:'shower, towels and linen', featureWifi:'Wi‑Fi', featureWifiSub:'Fast complimentary internet', featureCheckin:'Self check‑in', featureCheckinSub:'Key in a lockbox', featureComfort:'Comfortable stay', featureComfortSub:'Everything for your convenience', locationHint:'Open the map to see the exact apartment location.',
    ...
    aBedText:'A double sleeping space for a comfortable rest.', aKitchen:'Kitchenette', aKitchenText:'Coffee, tea, tableware and cutlery for a simple breakfast.',
    ...
    galleryEyebrow:'TAKE A CLOSER LOOK', galleryTitle:'The apartment in detail.', allPhotos:'All 12 photos', gApartment:'Interior',
    ...
    bookAirbnb:'Book on Airbnb', checkinText:'Self check‑in · key in a lockbox', backTop:'Back to top', galleryDialogLabel:'GALLERY', close:'Close',
  ...
  lt: {
    ...
    featureCenterSub:'Pylimo g., šalia Senamiesčio', featureKitchen:'Mini virtuvė', featureKitchenSub:'kava, arbata, indai ir įrankiai',
    featureLift:'Liftas', featureLiftSub:'pastate', featureBathroom:'Privatus vonios kambarys', featureBathroomSub:'dušas, rankšluosčiai ir patalynė', featureWifi:'Wi‑Fi', featureWifiSub:'Greitas nemokamas internetas', featureCheckin:'Savarankiškas atvykimas', featureCheckinSub:'Raktas dėžutėje', featureComfort:'Patogus poilsis', featureComfortSub:'Viskas jūsų patogumui', locationHint:'Atidarykite žemėlapį, kad pamatytumėte tikslią apartamentų vietą.',
    ...
    aBedText:'Dvigulė miegamoji vieta patogiam poilsiui.', aKitchen:'Mini virtuvė', aKitchenText:'Kava, arbata, indai ir įrankiai paprastiems pusryčiams.',
    ...
    galleryEyebrow:'PAŽVELKITE IŠ ARČIAU', galleryTitle:'Apartamentai iš arčiau.', allPhotos:'Visos 12 nuotraukų', gApartment:'Interjeras',
    ...
    bookAirbnb:'Rezervuoti per Airbnb', checkinText:'Savarankiškas atvykimas · raktas dėžutėje', backTop:'Į viršų', galleryDialogLabel:'GALERIJA', close:'Uždaryti',
  ...
  de: {
    ...
    featureCenterSub:'Pylimo, nahe der Altstadt', featureKitchen:'Kochnische', featureKitchenSub:'Kaffee, Tee, Geschirr und Besteck',
    featureLift:'Aufzug', featureLiftSub:'im Gebäude', featureBathroom:'Eigenes Bad', featureBathroomSub:'Dusche, Handtücher und Bettwäsche', featureWifi:'Wi‑Fi', featureWifiSub:'Schnelles kostenloses Internet', featureCheckin:'Self Check‑in', featureCheckinSub:'Schlüssel im Safe', featureComfort:'Komfortabler Aufenthalt', featureComfortSub:'Alles für Ihren Komfort', locationHint:'Öffnen Sie die Karte, um die genaue Lage des Apartments zu sehen.',
    ...
    aBedText:'Ein Doppel-Schlafplatz für einen angenehmen Aufenthalt.', aKitchen:'Kochnische', aKitchenText:'Kaffee, Tee, Geschirr und Besteck für ein einfaches Frühstück.',
    ...
    galleryEyebrow:'SEHEN SIE NÄHER HIN', galleryTitle:'Das Apartment im Detail.', allPhotos:'Alle 12 Fotos', gApartment:'Innenraum',
    ...
    bookAirbnb:'Auf Airbnb buchen', checkinText:'Self Check‑in · Schlüssel im Safe', backTop:'Nach oben', galleryDialogLabel:'GALERIE', close:'Schließen',
